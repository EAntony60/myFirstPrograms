...
public class StudentsFrame extends JFrame{
	...
	public StudentsFrame() {
		...
		//Создаем визуальный список и вставляем его в скроллируему панель
		//которую в свою очередь уже кладем на панель left
		...
		//Создаем визуальный список и вставляем его в скроллируемую панель
		//которую в свою очередь уже кладем на панель right
		stdList = new JList(st);
		right.add(new JScrollPane(stdList), BorderLayout.CENTER);
		
		//вставляем панели со списками гурпп и студентов в нижнюю панель
		bot.add(left, BorderLayout.NORTH);
